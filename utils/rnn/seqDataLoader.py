...
import torch
import random
from utils.rnn.textPreprocessing import load_corpus_time_machine
...
def test_seq_data_iter_sequential():
    my_seq = list(range(35))
...
def test_load_data_time_machine():
