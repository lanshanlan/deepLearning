...
from utils.rnn.coder import Encoder, Decoder, EncoderDecoder
from utils.train_ch3 import Animator, Accumulator
from utils.timer import Timer
from recurrentNeuralNetwork.rnn_train_ch8 import grad_clipping
from utils.gpu import try_gpu
from utils.rnn.neuralMachineTranslation import load_data_nmt, truncate_pad
...
class Seq2SeqDecoder(Decoder):
    ...
    def forward(self, X, state):
        ...
        # state[0]的形状是(num_layers, batch_size, num_hiddens)
        return output, state
    
def test_Seq2seqDecoder():
...
def bleu(pred_seq, label_seq, k):
    """计算BLEU (bilingual evaluation understudy)"""
